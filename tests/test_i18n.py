...
class InternationalizationTests(unittest.TestCase):
    ...
    def test_authenticated_language_is_saved_and_restored_on_login(self):
        ...
        self.assertIn("Out-of-stock products", html)
        self.assertIn("You have no out-of-stock products", html)
        self.assertIn("View out-of-stock products", html)
        self.assertIn("Today's sales", html)
        self.assertIn("0 tickets recorded today", html)
        self.assertIn("View today's sales", html)
        self.assertIn("Sales this month", html)
        self.assertNotIn("Average ticket", html)
